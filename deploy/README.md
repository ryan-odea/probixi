...
```bash
mkdir -p /opt/software/probixi/0.6.0
apptainer pull /opt/software/probixi/0.6.0/probixi.sif \
    oras://ghcr.io/ryan-odea/probixi:0.6.0
```

Place `modulefile/probixi.lua` in your MODULEPATH as `probixi/0.6.0.lua`. Set
